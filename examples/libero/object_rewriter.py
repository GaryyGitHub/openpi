...
def _parse_objects_section(bddl_content: str) -> tuple[int, int, str] | None:
...
def _add_distractor_objects(bddl_content: str, num_distractors: int = 1) -> str:
...
def rewrite_object_variants(bddl_content: str, num_variants: int = 1) -> dict[str, str]:
    ...
    return {ptype: rewrite_object_instruction(bddl_content, ptype) for ptype in perturbation_types}
